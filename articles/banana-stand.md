...
Contrast this with **Fireworks.ai**, which gives a 50% cache discount on *all text and vision models* — proprietary or open-source, no distinction. This is why the chat mentioned their company actively evaluating Fireworks.ai: "We are literally looking at fireworks.ai so we can start using open-source models at work. Because I see the monthly bills for AI tokens."
